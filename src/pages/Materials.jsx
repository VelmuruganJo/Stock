...
<div className={`stock-page ${darkMode ? "dark" : ""}`}>
...
<input type="text" placeholder="Currency" className="form-input"
...
<td onClick={()=>editMaterial(r)} style={{color:"blue",cursor:"pointer",fontWeight:"bold"}}>
{r.materialCode}
</td>
